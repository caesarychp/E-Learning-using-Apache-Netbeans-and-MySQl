...
public class Main extends JFrame implements ActionListener{
    ...
    JMenuBar menuBar;
    JMenu file, about;
    JMenuItem aboutProject,aboutDevelopers, exit, aboutSystem;
    ...
    public Main(){
        ...
        file = new JMenu("File");
        file.add(exit);
        about.add(aboutProject); about.add(aboutDevelopers); about.add(aboutSystem);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        else if (ae.getSource() == aboutSystem){
            new AboutSystem();
        }
